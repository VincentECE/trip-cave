...
export const CURRENT_HOST_IP = "http://192.168.87.20:"; //todo: since we aren't serving the files through express, this needs to change to match whever vite is hosting the clients
